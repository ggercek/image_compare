...
class Config:
    def __init__(self, input_file, output_file, overwrite_output=False, distance="ssim", log_level="INFO"):
    ...
    def __repr__(self):
        return f"Config [input:{self.input_file}, output:{self.output_file}, " \
               f"overwrite_output: {self.overwrite_output}, distance:{self.distance}, log_level:{self.log_level}]"
